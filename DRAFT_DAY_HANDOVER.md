...
| Gate | State |
| --- | --- |
| 2026-08-28 post-live control candidate | Local mechanics gate **PASS** for companion v0.2.28: source SHA-256 `e253c4dac6bacf791bc15cc729a6229e42ef5c0f7708ae9bfca4f64c52f21074`, ZIP SHA-256 `4f0d8d06146fe58f2388b180a8b600332d11c33d9f4900450f2425c9c9374a79`, 18 files. `npm test` passes 606/606 with deterministic 20+20 drafts; live control 424/424; focused actions 135/135; ten visual scenarios; contention; 9/9 chaos; 82/82 production-path acknowledgments at action p99 468.31 ms; 1,000/1,000 load requests at p95 12.59/p99 20.94 ms; 150-poll short soak at p99 14.00 ms and 0.75% growth; dependency audit zero vulnerabilities. Current authenticated arming remains **NO-GO**: `TRADYR_API_KEY` is absent, no exact current 5/5 schema-v3 snapshot is available, Chrome has not proven the installed companion was reloaded to v0.2.28, and the exact two-tab no-click, authenticated normal/rapid/recovery salary-cap, snake regression, and three-hour soak gates remain. Synthetic or local evidence does not certify current rankings or a room. |
